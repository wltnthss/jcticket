    ...
    <header class="play-top_main" id = "play-top">
        ...
        <div class="play-top-right">
            ...
            <a href="${pageContext.request.contextPath}/notice/paging" class="notice">
                <img src="${pageContext.request.contextPath}/resources/img/components/공지사항_백.png" class="notice_icon">
            </a>
            <c:choose>
                <c:when test="${empty sessionScope.sessionId}">
                    <!-- 로그인 상태가 아니면(세션이 없으면) 로그인 링크를 보여줌 -->
                    <a href="${pageContext.request.contextPath}/login" class="login">
                        <img src="${pageContext.request.contextPath}/resources/img/components/로그인_백.png" class="login_icon">
                    </a>
                </c:when>
                <c:otherwise>
                    <!-- 로그인 상태이면(세션이 있으면) 로그아웃 링크를 보여줌 -->
                    <a href="${pageContext.request.contextPath}/logout" class="logout" style="width: 22px;">
                        <img src="${pageContext.request.contextPath}/resources/img/components/로그아웃_백.png" class="logout_icon">
                    </a>
                </c:otherwise>
            </c:choose>
            <a class="search">
    ...
    <div class="cont">
        ...
        <div class="con-center">
            ...
            <a href="${pageContext.request.contextPath}/notice/paging">
                <img src="${pageContext.request.contextPath}/resources/img/components/공지사항.png">
            </a>
            <span>공지사항</span>
            </div>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <a href="${pageContext.request.contextPath}/logout">
                            <img src="${pageContext.request.contextPath}/resources/img/components/로그아웃_흑.png">
                        </a>
                        <span>로그아웃</span>
                    </c:otherwise>
                </c:choose>
...
<script src="${pageContext.request.contextPath}/resources/js/index/top_slide.js"></script>
<%--section5끝--%>
