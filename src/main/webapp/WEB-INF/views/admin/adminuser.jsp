            ...
            <div class="admin-common-title">
                ...
                <div class="notice-paging">
                    <c:if test="${paging.showPrev}">
                        ...
                        <a class="notice-paging-pageitems" href="${pageContext.request.contextPath}/admin/user?page=${paging.page-1}&option=${paging.option}&keyword=${paging.keyword}"> < </a>
                    </c:if>
                    ...
                    <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                        ...
                        <c:if test="${i ne paging.page}">
                            ...
                            <a class="notice-paging-pageitems" href="${pageContext.request.contextPath}/admin/user?page=${i}&option=${paging.option}&keyword=${paging.keyword}">${i}</a>
                        </c:if>
                    </c:forEach>
