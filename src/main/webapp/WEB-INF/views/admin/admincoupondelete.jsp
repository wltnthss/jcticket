...
<div class="admin-common-wrap">
    ...
    <div class="admin-common-content">
        <div class="admin-common-title">
            ...
            <div class="tbl_header">
                <table>
                    ...
                    <c:forEach items="${list}" var="CouponDto">
                        <tr class="list">
                            <td><input type="checkbox" name="selectedItems" value="${CouponDto.coupon_id}"></td>
            ...
            <div class="btn-confirm">
                <input type="button" value="삭제" id="coupon-delete-btn" class="btn-large" style="background: red">
            </div>
        </div>
    </div>
</div>
