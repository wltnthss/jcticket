    ...
    <div class="admin-common-wrap">
        ...
        <div class="admin-common-content">
            <div class="admin-common-title">
                ...
                <h2>공연 검색</h2>
            <hr>
            <form id="userSearch" action="${pageContext.request.contextPath}/admin/product" method="get">
                <div class="user-form">
                    <table>
                        <colgroup>
                            <col class="user-w100">
                    ...
                    <c:forEach items="${list}" var="p">
                        <tr class="list">
                            ...
                            <td style="text-align: left">
                                <span style="font-weight: bold; text-decoration-line: underline"><a style="font-size: 14px !important;" href="${pageContext.request.contextPath}/admin/productmodify/${p.play_id}/${p.showing_seq}?page=${paging.page}">${p.play_name}</a></span><br>
<%--                                    <span style="font-weight: bold; font-size: 14px">${p.play_name}</span><br>--%>
            ...
            <div class="notice-paging">
                <c:if test="${paging.showPrev}">
                    ...
                    <a class="notice-paging-pageitems" href="${pageContext.request.contextPath}/admin/product?page=${paging.page-1}&option=${paging.option}&keyword=${paging.keyword}&start_at=${paging.start_at}&end_at=${paging.end_at}&status=${paging.status}&category=${paging.category}"> < </a>
                </c:if>
                ...
                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                    ...
                    <c:if test="${i ne paging.page}">
                        ...
                        <a class="notice-paging-pageitems" href="${pageContext.request.contextPath}/admin/product?page=${i}&option=${paging.option}&keyword=${paging.keyword}&start_at=${paging.start_at}&end_at=${paging.end_at}&status=${paging.status}&category=${paging.category}">${i}</a>
                    </c:if>
                </c:forEach>
