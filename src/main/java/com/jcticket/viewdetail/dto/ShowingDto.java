...
public class ShowingDto {
    ...
    public ShowingDto(String showing_info, String showing_date, String showing_day, String showing_status, int showing_seat_cnt, int showing_seat_price, String play_id, String stage_id, String created_id, String updated_id){
        ...
        this.showing_seat_price = showing_seat_price;
        this.play_id = play_id;
        this.stage_id = stage_id;
        this.created_id = created_id;
        this.updated_id = updated_id;
    }
    public ShowingDto(int showing_seq, String showing_info, String showing_date, String showing_day, String showing_status, int showing_seat_cnt, int showing_seat_price, String play_id, String stage_id, String created_id, String updated_id){
