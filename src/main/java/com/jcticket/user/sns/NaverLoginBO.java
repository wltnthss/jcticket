...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "0VtfnTinAENAmq1FwmWE";
    private final static String CLIENT_SECRET = "Nw6SaIwrf3";
    private final static String REDIRECT_URI = "http://localhost:8080/login/naverCb";
